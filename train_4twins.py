...
from data import Data_Train_Val_Couple


if __name__ == '__main__':
    tf.reset_default_graph()
    # TO CONFIGURE: pos_neg.txt is the file whose each line is the absolute path to a training image
    data = Data_Train_Val_Couple({'pos_neg': 'pos_neg.txt'}, max_items=880000)
